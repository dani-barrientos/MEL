...
namespace mpl
{
    ...
    */
    ...
    template <class TTypes > class Tuple : public _private::Tuple_Base< TTypes,typename mpl::typelist::Sort<TTypes,_private::PackCondition>::Result, Length<TTypes>::result >
    {
        enum{ totallength = Length<TTypes>::result};
        typedef typename mpl::typelist::Sort<TTypes,_private::PackCondition>::Result SortedTypes;
        ...
        //TODO esto de la referencia no puede estar bien tan a la ligera. ¿QUé pasa con los atributos que ya son referencia?
