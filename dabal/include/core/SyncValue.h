...
namespace core
{
	...
	* @todo hay que refinar esta idea, hecha a prisa y corriendo. Realmente se corresponde con los atomic, así que ya no creo que tenga sentido
	*/
