...
namespace core
{
	...
	*/
	...
	public:
		 ...
		 * @param[in] F Callable wit signature \ref::core::ECallbackResult( \ref ::core::FutureValue&);
	...
	/**
	* @brief Represents a value that *maybe* is not present at the current moment. This value will be generated by *someone* and will be available at "some moment"
	* The value is retrieved using various ways:
	*	- pooling in a loop checking for "getValid" and "error"
	*	- using wait functions, as ::tasking::waitForFutureMThread or ::core::waitForFutureThread
