...
// rdi,rsi,rdx,rcx
__attribute__( ( naked ) ) static volatile void
_checkMicrothread( MThreadAttributtes*, uint64_t msegs, Process* p,
                   void* _executePtr )
{
...
__attribute__( ( naked ) ) static volatile void _switchMT( MThreadAttributtes* )
{
    ...
    asm volatile( "call mel_tasking_resizeStack" );
    asm volatile( "add %r15,%rsp" );
