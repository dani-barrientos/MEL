 ...
 */
#define MEL_CORE_OBJECT_TYPEINFO_ROOT \
	private: \
	static const ::mel::core::Type TYPE; \
	public: \
	inline static const ::mel::core::Type &type(){return TYPE;} \
	virtual const ::mel::core::Type &getMyType() const {return TYPE;} \
	private:

#define MEL_CORE_OBJECT_TYPEINFO \
	private: \
	static const ::mel::core::Type TYPE; \
	public: \
	inline static const ::mel::core::Type &type(){return TYPE;} \
	virtual const ::mel::core::Type &getMyType() const override {return TYPE;} \
	private:
...
*/
#define MEL_CORE_OBJECT_TYPEINFO_IMPL_ROOT(_type_) \
	const ::mel::core::Type _type_::TYPE(#_type_); 
...
*/
#define MEL_CORE_OBJECT_TYPEINFO_IMPL(_type_,_ancestorType_) \
	const ::mel::core::Type _type_::TYPE(#_type_,&_ancestorType_::type());

#define MEL_CORE_OBJECT_TYPEINFO_IMPL2(_type_,_ancestorType1_,_ancestorType2_) \
	const ::mel::core::Type _type_::TYPE(#_type_,&_ancestorType1_::type(),&_ancestorType2_::type() );

#define MEL_CORE_OBJECT_TYPEINFO_IMPL3(_type_,_ancestorType1_,_ancestorType2_,_ancestorType3_) \
	const ::mel::core::Type _type_::TYPE(#_type_,&_ancestorType1_::type(),&_ancestorType2_::type(),&_ancestorType3_::type() );

#define MEL_CORE_OBJECT_TYPEINFO_IMPL4(_type_,_ancestorType1_,_ancestorType2_,_ancestorType3_,_ancestorType4_) \
	const ::mel::core::Type _type_::TYPE(#_type_,&_ancestorType1_::type(),&_ancestorType2_::type(),&_ancestorType3_::type(),&_ancestorType4_::type() );
