...
namespace mel
{
    namespace core
    {
        ...
        * @todo probablemente deber�a pasar el tipo de puntero, pero as� lo facilito un poco
        */
        ...
        template<class T, bool isAbstract = true,bool useSmartPtr = true,
            template<class> class ThreadingPolicy = ::mel::core::Singleton_Singlethread_Policy >
