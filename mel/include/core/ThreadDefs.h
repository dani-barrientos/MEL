...
namespace mel
{
    namespace core
    {
        ...
        enum class EThreadPriority
        {
            ...
            TP_NORMAL = 0x03, /**< Normal/standard priority. This is the default
                                 priority new threads are assigned if none is
                                 specified */
            TP_HIGH = 0x04,   /**< High priority. Use with caution. */
            TP_HIGHEST =
                0x05, /**< Highest/realtime priority. May cause the system to
                         become irresponsive while the thread is running. */
            TP_NONE
        };
#ifdef WIN32
