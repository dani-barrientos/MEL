 ...
 */
        ...
        template <class TRet, VARIABLE_ARGS> class CallbackInterface_Base
        {
          public:
            ...
            virtual bool operator==(
                ...
                const = 0;
            virtual CallbackInterface_Base<TRet, VARIABLE_ARGS_DECL>*
            clone() const = 0;
        };
        template <class TRet, VARIABLE_ARGS>
        class CallbackInterface
            : public CallbackInterface_Base<TRet, VARIABLE_ARGS_DECL>
        {
        ...
        template <class TRet>
        class CallbackInterface<TRet>
            : public CallbackInterface_Base<TRet, void>
        {
        ...
        template <class TRet, VARIABLE_ARGS>
        class CallbackInterface<TRet, VARIABLE_ARGS_DECL, void>
            : public CallbackInterface_Base<TRet, VARIABLE_ARGS_DECL>
        {
