...
namespace mel
{
	namespace core {
		...
		/**
		* @class Lock
		* @brief Helper class for easy use of the CriticalSection class to lock scopes. 
		* @details You just have to declare a 'Lock' local variable
