...
int a;
linkFunctor< void,TYPELIST(XNode*,int&) >( fTest,mpl::_v2,'a',mpl::_v1 )( mel::mpl::functorWrapper<XNode*>(createXNode),mpl::createRef(a));
*/
namespace mel
{
	namespace mpl
	{
		...
		*/
		...
		public:
			...
			{
				return mel::mpl::equal<true>(f1,ob2.f1); //TODO atencion que todav�a no vale
			}
			T f1;
		protected:
		...
		public:
			...
			{
				return mel::mpl::equal<true>(f2,ob2.f2);
			}
			T f2;
		protected:
		...
		public:
			...
			{
				return mel::mpl::equal<true>(f3,ob2.f3); //TODO atencion que todav�a no vale
			}
			T f3;
		protected:
		...
		public:
			...
			{
				return mel::mpl::equal<true>(f4,ob2.f4); //TODO atencion que todav�a no vale
			}
			T f4;
		protected:
		...
		public:
			...
			{
				return mel::mpl::equal<true>(f5,ob2.f5); //TODO atencion que todav�a no vale
			}
			T f5;
		protected:
		...
		public:
			...
			{
				return mel::mpl::equal<true>(f6,ob2.f6); //TODO atencion que todav�a no vale
			}
		T f6;
		protected:
					...
					>
		{
			protected:
				...
				{
					return mel::mpl::equal<true>( *((Fixed1<TArg1>*)this),ob2 );
				}
	...
	*/
	//TODO la idea es despu�s que donde en TListVariable haya un NullType se ignore
