...
/**
 * @file utilities.h
 * @brief Utilities on tasking, because lack of a better place...Some funcions
 * are intended to be put in a custom file/class..
 *
 */
 ...
 */
        /**
         * @brief Waits for future completion, returning a wapper around the
         * internal vale
         * @param ErrorType specify how error is managed, by throwing an
         * exception (if used mel::core::WaitErrorAsException) or not (uf used
         * mel::core::WaitErrorNoException)
         * @throws if ErrorType == mel::core::WaitErrorAsException, throws
         * mel::core::WaitException if some error occured while waiting of the
         * internal future exception if it has any error
         */
         ...
         * activated in the context of a \ref ::mel::tasking::Process
         * "microthread"
         */
