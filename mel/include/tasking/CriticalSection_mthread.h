...
namespace mel
{
    namespace tasking
    {
        ...
        /**
         * @brief A critical section for synchronizing microthreads (AKA \ref
        ...
        template <bool multithread = true> class CriticalSection_mthread
        {
          public:
             ...
             * @return if false, then can't eneter critical section (becausee
             * process kill, for example)
          ...
          private:
            ...
            std::atomic<int> mCount; // number of times owner as acquired
                                     // section
        };
        ///@cond HIDDEN_SYMBOLS
        ...
        class Lock_mthread
        {
          public:
            ...
            Lock_mthread( CriticalSection_mthread<ismth>& cs )
                : mWrapper( new _private::_Wrapper<ismth>( cs ) )
            {
            }
